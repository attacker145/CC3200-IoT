...
typedef enum{
    // Choosing -0x7D0 to avoid overlap with/ host-driver's error codes
...
//*****************************************************************************
//
//! The application-defined hook (or callback) function is the tick hook.
...
//*****************************************************************************
//
//! The application provided a stack overflow hook function.
//!
